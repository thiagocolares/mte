...
$.Autocompleter.Cache = function(options) {
	...
	function matchSubset(s, sub) {
		if (!options.matchCase)
            s = accentStrip(s.toLowerCase());// Alterado por Sósthenes Neto.
//			s = s.toLowerCase();
		var i = s.indexOf(accentStrip(sub));// Alterado por Sósthenes Neto.
//		var i = s.indexOf(sub);
		if (options.matchContains == "word"){
			i = s.toLowerCase().search("\\b" + accentStrip(sub.toLowerCase()));// Alterado por Sósthenes Neto.
